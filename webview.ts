...
export function form_EnviarEmail(): string {
    return `
        ...
        <div class="w-100  min-vh-100 d-flex row bg-custom-dark mx-0">
           <nav class="col-3 border-end min-vh-100">
            ...
            <!-- Início do Formulário - Enviar E-mail -->
            ...
            <div class="col-9 content d-flex justify-content-center align-items-center ">
                <div class="card w-75 bg-custom-dark border border-light rounded" >
                    ...
                    <form id="emailForm" class="w-100 p-4">
                        <!-- Campo Sender (Email SMTP) -->
                        <div class="mb-3 row align-items-center">
                            <label for="email_smtp" class="col-sm-3 col-form-label text-white">Remetente (SMTP):</label>
                            <div class="col-sm-9">
                                <input type="email" class="form-control" id="email_smtp" placeholder="Digite o e-mail do remetente" required>
                            </div>
                        </div>

                        <!-- Campo Recipients (Destinatários) -->
                        <div class="mb-3 row align-items-center">
                            <label for="destinatario" class="col-sm-3 col-form-label text-white">Destinatários:</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="destinatario" placeholder="Digite os e-mails dos destinatários separados por vírgula" required>
                            </div>
                        </div>

                        <!-- Campo Subject (Assunto) -->
                        <div class="mb-3 row align-items-center">
                            <label for="assunto" class="col-sm-3 col-form-label text-white">Assunto:</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="assunto" placeholder="Digite o assunto do e-mail" required>
                            </div>
                        </div>

                        <!-- Campo Body (Corpo do E-mail) -->
                        <div class="mb-3 row align-items-center">
                            <label for="corpo_email" class="col-sm-3 col-form-label text-white">Corpo do E-mail:</label>
                            <div class="col-sm-9">
                                <textarea class="form-control" id="corpo_email" rows="4" placeholder="Escreva o corpo do e-mail" required></textarea>
                            </div>
                        </div>

                        <!-- Campo Attachments (Anexos) -->
                        <div class="mb-3 row align-items-center">
                            <label for="anexos" class="col-sm-3 col-form-label text-white">Anexos:</label>
                            <div class="col-sm-9">
            ...
            <!-- Fim do Formulário - Enviar E-mail -->
