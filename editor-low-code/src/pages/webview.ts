                        ...
                        <h5 class="card-header bg-success text-light rounded-top py-2">Esperar Elemento</h5>                            
                            ...
                            <form id="element" class="w-100 p-4">
                                <div class="mb-3 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="locators" placeholder="Locator element" required>
                                    </div>
                                </div>
                                <div class="mb-3 row align-items-center">
                                    <label for="timeout" class="col-sm-3 col-form-label text-white">Timeout:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="timeout" placeholder="Timeout" required>
                                    </div>
                                </div>
                                <div class="mb-3 row align-items-center">
                                    <label for="error" class="col-sm-3 col-form-label text-white">Error:</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" id="error"  placeholder="Message Error" required></textarea>
                                    </div>
                                </div>
