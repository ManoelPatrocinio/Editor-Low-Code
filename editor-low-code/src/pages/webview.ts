    ...
    return `
                ...
                <ul class="w-100  ps-3">
                    ...
                    <div class="collapse bg-transparent ps-4 mt-2 mb-4  " id="collapseSendEmails">
                        <ul class="w-100 h-100 ps-1">
                            <li class="mb-3">
                                <a class="w-100 text-light mb-3" href="#" id="sendEmail">
                                    Enviar E-mail
                                    <br />
                            ...
                            <li>
                                <a class="w-100 text-light " href="#" id="filterEmail">
                                    Filtrar E-mails
                                    <br />
                                    <small  class="ps-2" style="color: #cecece;">Regras para filtrar e-mails</small>
                                </a>
                            </li>
                        </ul>
        ...
        <script>
            ...
            sendEmail.addEventListener('click', () => {
                vscode.postMessage({ command: 'comandName' });
            });
        </script>
    ...
    return `
            ...
            <nav class="col-3 border-end vh-100">
                ...
                <ul class="w-100  ps-3">
                    ...
                    <div class="collapse bg-transparent ps-4 mt-2 mb-4  " id="collapseSendEmails">
                        <ul class="w-100 h-100 ps-1">
                            <li class="mb-3">
                                <a class="w-100 text-light mb-3" href="#" id="Email">
                                    Enviar E-mail
                                    <br />
                                    <small  class="ps-2" style="color: #cecece;">Envio para um destinátario</small>
                                </a>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                const btn_sendoEmailSimples = document.getElementById('sendSimpleEmail');
